                                            ...
                                            <div className="sign-up-htm">
                                                ...
                                                <form>
                                                    <div className="form-group">
                                                        ...
                                                        <MDBInput label="Specialités" icon="thumbs-up" id="trois" type="text" className="input" name="specialite" value={this.state.value} placeholder="spécialités d'utilisateur" onChange={this.handleChange} />
